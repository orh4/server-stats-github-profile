...
# SECTIONS
- [STEP 0 (required packages)](#step-0-required-packages)

- [STEP 1 (cloning this repository)](#step-1-cloning-this-repository)

- [STEP 2 (cloning your desired repository)](#step-2-cloning-your-desired-repository)

- [STEP 3 (moving the contents from this repo to your repo)](#step-3-moving-the-contents-from-this-repo-to-your-repo)

- [STEP 4 (making a fine-grained token)](#step-4-making-a-fine-grained-token)

- [STEP 5 (pushing changes + setting up a both account)](#step-5-pushing-changes--setting-up-a-bot-account)

- [STEP 6 (configuration)](#step-6-configuration)

- [STEP 7 (verification and github actions)](#step-7-verification-and-github-actions)

- [STEP 8 (automation)](#step-8-automation)
